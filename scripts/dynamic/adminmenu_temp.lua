...
function ADMIN:BuildAdminMenu(unit,playername)
  ...
  MENU_GROUP_COMMAND:New(adminGroup, "Load DAY PG", adminMenu, ADMIN.LoadMission, self, playername, 1 )
  MENU_GROUP_COMMAND:New(adminGroup, "Load NIGHT PG", adminMenu, ADMIN.LoadMission, self, playername, 2 )
  MENU_GROUP_COMMAND:New(adminGroup, "Load WEATHER PG", adminMenu, ADMIN.LoadMission, self, playername, 3 )
  MENU_GROUP_COMMAND:New(adminGroup, "Load NIGHT WEATHER PG", adminMenu, ADMIN.LoadMission, self, playername, 4 )
end
